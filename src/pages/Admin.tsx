...
const Admin = () => {
  ...
  const toggleAdminPick = (domainId: string) => {
    setDomains(
      domains.map((domain) =>
        domain.id === domainId
          ? { ...domain, isAdminPick: !domain.isAdminPick }
          : domain
      )
    );
  ...
  const toggleSponsored = (domainId: string) => {
    setDomains(
      domains.map((domain) =>
        domain.id === domainId
          ? { ...domain, isSponsored: !domain.isSponsored }
          : domain
      )
    );
        ...
        <Tabs defaultValue="domains" className="space-y-4">
          ...
          <TabsContent value="domains">
            <Card>
              ...
              <CardContent>
                {isLoading ? (
                  <p className="text-center py-8">Loading domains...</p>
                ) : (
                            ...
                            <td className="p-3">
                              <div className="flex items-center space-x-2">
                                <Switch
                                  ...
                                  onCheckedChange={() => toggleAdminPick(domain.id)}
                                />
                            ...
                            <td className="p-3">
                              <div className="flex items-center space-x-2">
                                <Switch
                                  ...
                                  onCheckedChange={() => toggleSponsored(domain.id)}
                                />
